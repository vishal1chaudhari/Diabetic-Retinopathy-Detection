...
root.title("Diabetic Detection System")
...
#
lbl = tk.Label(root, text="    Daibetic Retinopaphy  ", font=('Georgia', 35,' bold '), height=1, width=28,bg="black",fg="white")
...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=230, height=350, bd=5, font=('times', 14, ' bold '),bg="honeydew4")
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('diebetic_model.h5')
        ...
        if food == 0:
            Cd="first Stage Diabetic"
        elif food == 1:
            Cd="Second Stage Diabetic"
        elif food == 2:
            Cd="Third Stage Diabetic"
        elif food == 3:
            Cd="Four Stage Diabetic"
        elif food == 4:
            Cd="No Stage Diabetic"
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='C:/Users/Dell/OneDrive/Desktop/100%code/100%code/Diabetic Detection/Diabetic Detection/test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
