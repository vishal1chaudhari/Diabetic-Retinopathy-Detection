...
window = tk.Tk()
window.geometry("700x700+450+10")
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#000000", fg="white")
l1.place(x=190, y=50)
...
btn = tk.Button(window, text="Register", bg="#800000",font=("Times New Roman",20,"bold"),fg="White", width=9, height=1, command=insert)
