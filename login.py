...
root.geometry("%dx%d+0+0" % (750, 700))
...
user_icon=ImageTk.PhotoImage(file="C:/Users/Dell/OneDrive/Desktop/100%code/100%code/Diabetic Detection/Diabetic Detection/loginlogo.jpeg")
title=tk.Label(root, image=user_icon)
title.place(x=320,y=80,width=60)
        
Login_frame=tk.Frame(root,bg="")
Login_frame.place(x=120,y=170)
        
logolbl=tk.Label(Login_frame,text="Welcome to Sign In Page",compound=LEFT,font=("Times new roman", 20, "bold"),bg="white").grid(row=0,columnspan=2,pady=20)
