...
path1 = 'E:/Diabetic/die/die/Data/5'    #path of folder of images    
path2 = 'E:/Diabetic/die/die/test_set/5'  #path of folder to save images    
...
im1 = array(Image.open('Data/5/' + imlist[0])) # open one image to get size
